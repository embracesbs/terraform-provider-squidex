...
// ComponentsFieldPropertiesDto struct for ComponentsFieldPropertiesDto
type ComponentsFieldPropertiesDto struct {
	FieldPropertiesDto
...
func NewComponentsFieldPropertiesDto(fieldType string) *ComponentsFieldPropertiesDto {
	this := ComponentsFieldPropertiesDto{}
...
func (o *ComponentsFieldPropertiesDto) SetMinItemsNil() {
	o.MinItems.Set(nil)
}
...
func (o *ComponentsFieldPropertiesDto) SetMaxItemsNil() {
	o.MaxItems.Set(nil)
}
...
func (o ComponentsFieldPropertiesDto) MarshalJSON() ([]byte, error) {
...
type NullableComponentsFieldPropertiesDto struct {
	value *ComponentsFieldPropertiesDto
	isSet bool
}

func (v NullableComponentsFieldPropertiesDto) Get() *ComponentsFieldPropertiesDto {
	return v.value
}

func (v *NullableComponentsFieldPropertiesDto) Set(val *ComponentsFieldPropertiesDto) {
	v.value = val
	v.isSet = true
}

func (v NullableComponentsFieldPropertiesDto) IsSet() bool {
	return v.isSet
}

func (v *NullableComponentsFieldPropertiesDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComponentsFieldPropertiesDto(val *ComponentsFieldPropertiesDto) *NullableComponentsFieldPropertiesDto {
	return &NullableComponentsFieldPropertiesDto{value: val, isSet: true}
}

func (v NullableComponentsFieldPropertiesDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComponentsFieldPropertiesDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
