...
func (o *AssetDtoAllOf) SetFileHashNil() {
	o.FileHash.Set(nil)
}
...
func (o *AssetDtoAllOf) SetEditTokenNil() {
	o.EditToken.Set(nil)
}
...
func (o *AssetDtoAllOf) SetPixelWidthNil() {
...
func (o *AssetDtoAllOf) SetPixelHeightNil() {
...
func (o AssetDtoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAssetDtoAllOf struct {
	value *AssetDtoAllOf
	isSet bool
}

func (v NullableAssetDtoAllOf) Get() *AssetDtoAllOf {
	return v.value
}

func (v *NullableAssetDtoAllOf) Set(val *AssetDtoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetDtoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetDtoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetDtoAllOf(val *AssetDtoAllOf) *NullableAssetDtoAllOf {
	return &NullableAssetDtoAllOf{value: val, isSet: true}
}

func (v NullableAssetDtoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetDtoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
