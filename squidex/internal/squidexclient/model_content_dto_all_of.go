...
func (o *ContentDtoAllOf) SetNewStatusNil() {
	o.NewStatus.Set(nil)
}
...
func (o *ContentDtoAllOf) SetNewStatusColorNil() {
...
func (o *ContentDtoAllOf) SetEditTokenNil() {
	o.EditToken.Set(nil)
}
...
func (o *ContentDtoAllOf) SetSchemaNameNil() {
...
func (o *ContentDtoAllOf) SetSchemaDisplayNameNil() {
...
func (o ContentDtoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableContentDtoAllOf struct {
	value *ContentDtoAllOf
	isSet bool
}

func (v NullableContentDtoAllOf) Get() *ContentDtoAllOf {
	return v.value
}

func (v *NullableContentDtoAllOf) Set(val *ContentDtoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableContentDtoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableContentDtoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentDtoAllOf(val *ContentDtoAllOf) *NullableContentDtoAllOf {
	return &NullableContentDtoAllOf{value: val, isSet: true}
}

func (v NullableContentDtoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentDtoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
