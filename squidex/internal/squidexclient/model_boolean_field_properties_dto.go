...
func NewBooleanFieldPropertiesDto(fieldType string) *BooleanFieldPropertiesDto {
	this := BooleanFieldPropertiesDto{}
...
func (o *BooleanFieldPropertiesDto) SetDefaultValueNil() {
...
func (o BooleanFieldPropertiesDto) MarshalJSON() ([]byte, error) {
...
type NullableBooleanFieldPropertiesDto struct {
	value *BooleanFieldPropertiesDto
	isSet bool
}

func (v NullableBooleanFieldPropertiesDto) Get() *BooleanFieldPropertiesDto {
	return v.value
}

func (v *NullableBooleanFieldPropertiesDto) Set(val *BooleanFieldPropertiesDto) {
	v.value = val
	v.isSet = true
}

func (v NullableBooleanFieldPropertiesDto) IsSet() bool {
	return v.isSet
}

func (v *NullableBooleanFieldPropertiesDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBooleanFieldPropertiesDto(val *BooleanFieldPropertiesDto) *NullableBooleanFieldPropertiesDto {
	return &NullableBooleanFieldPropertiesDto{value: val, isSet: true}
}

func (v NullableBooleanFieldPropertiesDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBooleanFieldPropertiesDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
