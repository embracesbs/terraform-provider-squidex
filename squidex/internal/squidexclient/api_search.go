 ...
 * @param optional nil or *SearchGetSearchResultsOpts - Optional Parameters:
 * @param "Query" (optional.String) -  The search query.
@return []SearchResultDto
*/
func (a *SearchApiService) SearchGetSearchResults(ctx _context.Context, app string, localVarOptionals *SearchGetSearchResultsOpts) ([]SearchResultDto, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/apps/{app}/search"
