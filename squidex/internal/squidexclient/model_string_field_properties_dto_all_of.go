...
func NewStringFieldPropertiesDtoAllOf() *StringFieldPropertiesDtoAllOf {
	this := StringFieldPropertiesDtoAllOf{}
	return &this
}
...
func (o *StringFieldPropertiesDtoAllOf) SetDefaultValueNil() {
...
func (o *StringFieldPropertiesDtoAllOf) SetPatternNil() {
	o.Pattern.Set(nil)
}
...
func (o *StringFieldPropertiesDtoAllOf) SetPatternMessageNil() {
...
func (o *StringFieldPropertiesDtoAllOf) SetFolderIdNil() {
	o.FolderId.Set(nil)
}
...
func (o *StringFieldPropertiesDtoAllOf) SetMinLengthNil() {
	o.MinLength.Set(nil)
}
...
func (o *StringFieldPropertiesDtoAllOf) SetMaxLengthNil() {
	o.MaxLength.Set(nil)
}
...
func (o *StringFieldPropertiesDtoAllOf) SetMinCharactersNil() {
...
func (o *StringFieldPropertiesDtoAllOf) SetMaxCharactersNil() {
...
func (o *StringFieldPropertiesDtoAllOf) SetMinWordsNil() {
	o.MinWords.Set(nil)
}
...
func (o *StringFieldPropertiesDtoAllOf) SetMaxWordsNil() {
	o.MaxWords.Set(nil)
}
...
func (o StringFieldPropertiesDtoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableStringFieldPropertiesDtoAllOf struct {
	value *StringFieldPropertiesDtoAllOf
	isSet bool
}

func (v NullableStringFieldPropertiesDtoAllOf) Get() *StringFieldPropertiesDtoAllOf {
	return v.value
}

func (v *NullableStringFieldPropertiesDtoAllOf) Set(val *StringFieldPropertiesDtoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStringFieldPropertiesDtoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStringFieldPropertiesDtoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStringFieldPropertiesDtoAllOf(val *StringFieldPropertiesDtoAllOf) *NullableStringFieldPropertiesDtoAllOf {
	return &NullableStringFieldPropertiesDtoAllOf{value: val, isSet: true}
}

func (v NullableStringFieldPropertiesDtoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStringFieldPropertiesDtoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
