...
// NewAssetScriptsDtoAllOf instantiates a new AssetScriptsDtoAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAssetScriptsDtoAllOf() *AssetScriptsDtoAllOf {
	this := AssetScriptsDtoAllOf{}
	return &this
}

// NewAssetScriptsDtoAllOfWithDefaults instantiates a new AssetScriptsDtoAllOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAssetScriptsDtoAllOfWithDefaults() *AssetScriptsDtoAllOf {
	this := AssetScriptsDtoAllOf{}
	return &this
}

// GetCreate returns the Create field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AssetScriptsDtoAllOf) GetCreate() string {
...
func (o *AssetScriptsDtoAllOf) GetCreateOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *AssetScriptsDtoAllOf) HasCreate() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AssetScriptsDtoAllOf) GetUpdateOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *AssetScriptsDtoAllOf) HasUpdate() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AssetScriptsDtoAllOf) GetAnnotateOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *AssetScriptsDtoAllOf) HasAnnotate() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AssetScriptsDtoAllOf) GetMoveOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *AssetScriptsDtoAllOf) HasMove() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AssetScriptsDtoAllOf) GetDeleteOk() (*string, bool) {
	if o == nil {
    return nil, false
	}
...
func (o *AssetScriptsDtoAllOf) HasDelete() bool {
...
func (o *AssetScriptsDtoAllOf) SetDelete(v string) {
	o.Delete.Set(&v)
}
// SetDeleteNil sets the value for Delete to be an explicit nil
func (o *AssetScriptsDtoAllOf) SetDeleteNil() {
	o.Delete.Set(nil)
}

// UnsetDelete ensures that no value is present for Delete, not even an explicit nil
func (o *AssetScriptsDtoAllOf) UnsetDelete() {
	o.Delete.Unset()
}

// GetVersion returns the Version field value if set, zero value otherwise.
func (o *AssetScriptsDtoAllOf) GetVersion() int64 {
...
// and a boolean to check if the value has been set.
func (o *AssetScriptsDtoAllOf) GetVersionOk() (*int64, bool) {
	if o == nil || isNil(o.Version) {
    return nil, false
	}
...
func (o *AssetScriptsDtoAllOf) HasVersion() bool {
	if o != nil && !isNil(o.Version) {
		return true
	}
...
func (o *AssetScriptsDtoAllOf) SetVersion(v int64) {
	o.Version = &v
}

func (o AssetScriptsDtoAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAssetScriptsDtoAllOf struct {
	value *AssetScriptsDtoAllOf
	isSet bool
}

func (v NullableAssetScriptsDtoAllOf) Get() *AssetScriptsDtoAllOf {
	return v.value
}

func (v *NullableAssetScriptsDtoAllOf) Set(val *AssetScriptsDtoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetScriptsDtoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetScriptsDtoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetScriptsDtoAllOf(val *AssetScriptsDtoAllOf) *NullableAssetScriptsDtoAllOf {
	return &NullableAssetScriptsDtoAllOf{value: val, isSet: true}
}

func (v NullableAssetScriptsDtoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetScriptsDtoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
